...
export class FormDataSourceService {
  ...
  public getLocationDataSource() {
    let resolve = (uuid: string) => {
      return this.getLocationByUuid(uuid).pipe(map((location) => {
        let mappedLocation = {
          label: location.display,
          value: location.uuid,
          providerUuid: (location as any).uuid
        };
  ...
  public getProviderDataSource() {
    let resolve = (uuid: string) => {
      return this.getProviderByUuid(uuid).pipe(map(provider => {
        let mappedProvider = {
  ...
  public getProviderByUuid(uuid): Observable<any> {
    ...
    //   );
    return this.providerResourceService.getProviderByUuid(uuid, false);
  ...
  public findLocation(searchText): Observable<Location[]> {
    ...
    let findLocation = this.locationResourceService.searchLocation(searchText);
  ...
  public getLocationByUuid(uuid): Observable<any> {
    ...
    return this.locationResourceService.getLocationByUuid(uuid, false)
  }
